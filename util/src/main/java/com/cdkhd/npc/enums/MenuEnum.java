...
//    ANNOUNCEMENT(null, "公告信息",(byte)1, "announcement", "notification/announceList","NOTIFICATION", "MEMBER_HOUSE"),
    ...
    SUGGESTION_COUNT("suggestion_count", "代表建议统计",(byte)2, "menu-statistics", "/member_house/suggestion_count",null, "MEMBER_HOUSE"),
    PERFORMANCE_COUNT("performance_count", "代表履职统计",(byte)2, "menu-statisics2", "/member_house/performance_count",null, "MEMBER_HOUSE"),
