...
public enum SystemEnum {
    //小程序菜单类型
    BASIC_INFO("基本信息管理系统","home","basicInfo",null, "sub-systems/smart-platform.png", "../sub-systems/npc-home/npc-home", false),//name   type   url   parent
    ...
    PERFORMANCE("履职登记评价系统","duty",null,null, "sub-systems/duty-rate.png", "../sub-systems/performance-evaluation-sys/performance-evaluation-sys", true),
