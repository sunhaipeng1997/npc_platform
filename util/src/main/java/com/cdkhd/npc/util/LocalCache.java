...
import com.cdkhd.npc.entity.CacheEntity;
...
public class LocalCache {
    ...
    // 刷新缓存的频率
    private static int MONITOR_DURATION = 2000;
    // 启动监控线程
    static {
...
//                    System.out.println("Cache monitor");
    ...
    public static Integer getNumber(String key) {
        Integer number = (int)cache.getOrDefault(key, new CacheEntity(1)).getValue();
        Integer temp = number+1;
        LocalCache.putValue(key,temp,1*60*60*24);
        return number;
    }
}
